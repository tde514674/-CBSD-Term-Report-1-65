 ...
 * 
 */
@WebServiceClient(name = "CovidWebService", targetNamespace = "http://myservice/", wsdlLocation = "http://localhost:8080/CovidSoapService/CovidWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName COVIDWEBSERVICE_QNAME = new QName("http://myservice/", "CovidWebService");
    ...
    public CovidWebService getCovidWebServicePort() {
        return super.getPort(new QName("http://myservice/", "CovidWebServicePort"), CovidWebService.class);
    }
    ...
    public CovidWebService getCovidWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myservice/", "CovidWebServicePort"), CovidWebService.class, features);
    }
